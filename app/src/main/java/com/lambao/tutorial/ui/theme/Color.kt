...
val OrangeRed = Color(0xFFFF2B4E)
val AquaBlue = Color(0xff9aa5c4)
val OrangeYellow = Color(0xfff0bd28)
val Orange = Color(0xFFFF5722)
val Beige = Color(0xfff9a27b)
val LightGreen = Color(0xff54e1b6)
val BlueViolet = Color(0xffaeb4fd)

val PlaceHolder = Color(0XFF888D91)
val Background = Color(0xFFE6E6E6)